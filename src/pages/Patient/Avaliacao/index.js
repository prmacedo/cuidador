      ...
      {okToRender && (
        <div id="page-cuidadores" className="container">
          ...
          <Paper className={classes.paper}>
            ...
            <div className={classes.root}>
              <Box>
                <ToggleButtonGroup
                  value={pain}
                  exclusive
                  onChange={(event, selectedPain) => {
                    console.log(selectedPain);
                    setPain(selectedPain)
                  }}
                  aria-label="text alignment"
                  className={classes.toggleGroup}
                >
                  <ToggleButton value="1" aria-label="left aligned" className={classes.toggle} classes={{selected: classes.toggleSelected}}>
                    Sim
                  </ToggleButton>
                  <ToggleButton value="0" aria-label="centered" className={classes.toggle} classes={{selected: classes.toggleSelected}}>
                    Não
                  </ToggleButton>
                </ToggleButtonGroup>
              </Box>
            ...
            <h3 style={{ margin: "0px 0px 50px 0px" }}>Nas últimas 24 horas</h3>
            <Typography component="h2" variant="h6" align="center">
            ...
            <Typography component="h2" variant="h6" align="center">
              A dor que você está sentindo tem influenciado a sua relação com as
              outras pessoas?
            </Typography>
            <div>
              <Box>
